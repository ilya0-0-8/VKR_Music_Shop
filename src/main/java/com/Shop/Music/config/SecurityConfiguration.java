...
import com.Shop.Music.filter.JwtAuthenticationFilter;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
            http.csrf(AbstractHttpConfigurer::disable)
                    ...
                    .authorizeHttpRequests(request -> request
                            ...
                            .requestMatchers("/vacancy/list").hasRole("MANAGER")
                            ...
                            //.requestMatchers("/vacancy/setStatusOk").hasRole("MANAGER")
                            //.requestMatchers("/vacancy/setStatusBlock").hasRole("MANAGER")
                            .requestMatchers("/vacancy/searchVacancies").hasRole("MANAGER")
